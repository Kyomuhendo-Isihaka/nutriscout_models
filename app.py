...
# data = data.drop([0, 1])  # Drop first two rows (metadata)
...
# def get_nutrition_recommendations(age, gender, height, weight):
#     # Validate input data
#     if not isinstance(age, int) or age <= 0:
#         return {"Error": "Invalid age. Please provide a positive integer value for age in months."}
#     if gender.lower() not in ['boy', 'girl']:
#         return {"Error": "Invalid gender. Please specify 'boy' or 'girl'."}
#     if not (isinstance(height, (int, float)) and height > 0):
#         return {"Error": "Invalid height. Please provide a positive number for height in cm."}
#     if not (isinstance(weight, (int, float)) and weight > 0):
#         return {"Error": "Invalid weight. Please provide a positive number for weight in kg."}
    
#     # Filter data for the specific age
#     standards = data[data['AGE'] == age]
    
#     if standards.empty:
#         return {"Error": f"No data available for age {age} months."}
...
# # API endpoint to get nutrition recommendations
...
#     # Get nutrition recommendations based on inputs
#     result = get_nutrition_recommendations(age, gender, height, weight)
